...
## CFG
cfg_model_path = "models/yourModel.pt" # we cannot upload model to github becuse of large size
...
def imageInput(device, src):
    ...
    if src == 'Upload your own data.':
        ...
        imgpath = glob.glob('data/enhanced_images/*')
...
#     st.image(img_logo, caption='')
    ...
    st.subheader("Detect object/s in enhanced image", anchor=None)
